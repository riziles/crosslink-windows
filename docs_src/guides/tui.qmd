...
While agents handle implementation, the TUI lets you monitor what's happening across your project. It syncs data on startup and refreshes periodically in the background — press `r` for a manual refresh.
...
::: {.callout-note collapse="true" title="When to use TUI vs. Web Dashboard"}
