...
* **Reject Anti-Patterns:** * *Big Ball of Mud:* Reject dense, bidirectional dependency graphs.
...
* **SOLID Enforcement:** * *SRP:* Modules must have one reason to change. Reject merged UI/DB/Logic blocks.
